#O que é um cabeçalho para Python dentro de um arquivo?
#R: É um bloco no início do código, geralmente com comentários ou docstrings, que identifica e descreve o arquivo.
#para que serve?
#R: Serve para documentar o propósito do script, indicar o interpretador e facilitar a leitura e manutenção do código.
